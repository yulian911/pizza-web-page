...
const CartItem:FC<CartItemProps> = ({id,count,title,type,size,imageUrl,price}) => {
    const dispatch=useDispatch()

    const onClickPlus = () =>{
        dispatch(addItems({id} as ICartItem))
    }
    const onClickMinus = () =>{
  ...
  return (
    ...
    <div className="cart__item-count">
          <button 
          disabled={count === 1}
          className="button button--outline button--circle cart__item-count-minus" onClick={onClickMinus}>
